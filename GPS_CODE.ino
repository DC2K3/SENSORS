...
String DateString , TimeString , LatitudeString , speedString ,  LongitudeString;
...
void loop()
{
  ...
  //Response
  String s = "HTTP/1.1 200 OK\r\nContent-Type: text/html\r\n\r\n <!DOCTYPE html> <html> <meta http-equiv=\"refresh\" content=\"0.5\"> <head> <title>NEO-6M GPS Readings</title> <style>";
